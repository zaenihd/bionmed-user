...
class CardRecDoctor extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  final data;
  const CardRecDoctor({Key? key, this.data}) : super(key: key);

  @override
  State<CardRecDoctor> createState() => _CardRecDoctorState();
}

final cLog = Get.find<ControllerLogin>();

class _CardRecDoctorState extends State<CardRecDoctor> {
  @override
