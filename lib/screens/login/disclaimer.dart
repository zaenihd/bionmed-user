...
class Disclamer extends StatelessWidget {
  ...
  final loginC = Get.put(ControllerLogin());
...
// This is what you're looking for!
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          AppBar(title: const Text('Syarat dan Ketentuan Pengguna BionMed')),
            ...
            children: [
              ...
              Column(
                children: const [
                  ...
                  Text(
                    " +62 853 1111 1010",
                    style: TextStyle(
                        fontSize: 14, height: 1.8, color: Colors.blue),
                  ),
                ],
              ),
              const SizedBox(
              ...
              Row(
                ...
                children: [
                  ...
                  const Text('Setuju & Lanjutkan')
                ],
              ),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20.0),
                child: Obx(
                  () => loginC.rememberme.isFalse
                      ? ButtonPrimary(
                          enable: false, label: 'Lanjutkan', onPressed: () {})
                      : ButtonGradient(
                          label: 'Lanjutkan',
                          onPressed: () async {
                            if (loginC.rememberme.isTrue) {
                            ...
                            // Get.find<SplashScreenController>().getLocation();
