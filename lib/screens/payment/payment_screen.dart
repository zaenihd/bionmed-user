...
class _PaymentScreenState extends State<PaymentScreen> {
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
               "${Get.find<PilihJadwalController>().durasiLayanan.value} Menit",
                style:
                    TextStyles.subtitle3.copyWith(fontWeight: FontWeight.bold),
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Text(priceFormat(double.parse(Get.find<PilihJadwalController>().hargaKonsultasi.value)),
    ...
    return Container(
      ...
      child: Padding(
        ...
        child:
          ...
          // Text(priceFormat(double.parse(Get.find<PilihJadwalController>().totalBiaya.value)),
  ...
  Row widgetDoctorProfile() {
    return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Image.network("${Get.find<ControllerLogin>().dataDoctorDetail['image']}",
      ...
      Column(
        ...
        children: [
          Text("${Get.find<ControllerLogin>().dataDoctorDetail['name']}",
