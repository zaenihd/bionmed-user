...
class PesananStatusAmbulance extends StatefulWidget {
  const PesananStatusAmbulance({Key? key}) : super(key: key);
  static const routeName = "/pesanan_status_screen";

  @override
  State<PesananStatusAmbulance> createState() => _PesananStatusAmbulanceState();
}

class _PesananStatusAmbulanceState extends State<PesananStatusAmbulance>
  ...
  Column widgetStatusWaiting() {
    return Column(
      children: [
        ...
        Text(
          Get.find<ControllerPayment>().dataOrder['status'] == 2 || Get.find<ControllerPayment>().dataOrder['status'] == 1? "Pembayaran Berhasil" : 
          "Menunggu Pembayaran",
