...
class PaymentScreenAmbulance extends StatefulWidget {
  const PaymentScreenAmbulance({Key? key}) : super(key: key);
  static const routeName = "/pay_screen";

  @override
  State<PaymentScreenAmbulance> createState() => _PaymentScreenAmbulanceState();
}

class _PaymentScreenAmbulanceState extends State<PaymentScreenAmbulance> {
